...
const getAllFaculty = catchAsync(async (req: Request, res: Response) => {
  ...
  const result = await AcademicFacultyService.updateAcademicFaculty(id as string,payload)
  sendResponse<IAcademicFaculty>(res,{
    statusCode:httpStatus.OK,
    success:true,
...
const deleteAcademicFaculty = catchAsync(
    async(req:Request,res:Response)=>{
        const id = req.params.id;
        const result = await AcademicFacultyService.deleteAcademicFaculty(id as string)
        sendResponse(res,{
         statusCode:httpStatus.OK,
         success:true,
...
createAcademicFaculty,getAllFaculty,
